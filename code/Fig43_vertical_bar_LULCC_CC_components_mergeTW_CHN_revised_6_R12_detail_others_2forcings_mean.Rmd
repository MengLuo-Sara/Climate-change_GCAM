...
fig_case_name_in <- "_v4_R12_detail_other"
...
write.csv(merge_alltype,paste0(
    figure_save_path,
    "Fig43_merge_alltype_ukesm_gfdl_mean_",
    scenario,
    fig_case_name,
    ".csv"
  ))
...
ggsave(
  paste0(
    figure_save_path,
    "Fig43_LULCC_spatial_alltype_CC_components_diff_for_vertical_bar_2forcing_mean_",
    scenario,
    fig_case_name,
    ".svg"
  ),
