...
######################################################
  ...
  check_aboveCD_long_combine_2100<-check_aboveCD_long_combine%>%
    filter(year==2100)
write.csv( check_aboveCD_long_combine_2100,paste0(fig_save_path,"Fig23_check_aboveCD_long_combine_2100.csv"))
...
check_belowCD_long_combine$quantile_cat_3 <-
 ...
 check_belowCD_long_combine_2100<-check_belowCD_long_combine%>%
    filter(year==2100)
write.csv( check_belowCD_long_combine_2100,paste0(fig_save_path,"Fig23_check_belowCD_long_combine_2100.csv"))
...
combined_global_bgb_plot <- plot_grid(
 ...
 ggsave(paste0(fig_save_path, "/Fig23_CC_components_Sagb_bgb_spatial_v",version_num,".svg"), plot = combined_global_bgb_plot , width = 15*0.81, height = 9*0.81, units = "in")


ggsave(paste0(fig_save_path, "/Fig23_CC_components_Sagb_bgb_spatial_v",version_num,".pdf"), plot = combined_global_bgb_plot, width = 15*0.81, height = 9*0.81, units = "in")
ggsave(paste0(fig_save_path, "/Fig23_CC_components_Sagb_bgb_spatial_v",version_num,".png"), plot = combined_global_bgb_plot, width = 15*0.81, height = 9*0.81, units = "in", dpi = 300)
ggsave(filename = paste0(fig_save_path,"/Fig23_CC_components_Sagb_bgb_spatial_v", version_num, ".tif"),
