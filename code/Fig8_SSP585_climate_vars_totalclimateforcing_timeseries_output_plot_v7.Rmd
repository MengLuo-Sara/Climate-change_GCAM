...
long_total.climate.forcing_SSP_combines<-read.csv(paste0(figure_save_path,"total.climate.forcing_",scenario_set,"_gfdl_climate_vars_combines.csv"),row.names = "FALSE")
