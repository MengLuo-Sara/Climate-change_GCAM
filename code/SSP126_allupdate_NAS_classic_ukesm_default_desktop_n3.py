...
g = gcamwrapper.Gcam("configuration_policy_ssp126_usetax_ag_cost_prodchange_classic_ukesm2.xml", in_exe_path)
new_db_name = "SSP126_classic_ukesm_allupdate_db_v3_nege3_n3"
#######################################
...
agb_file_path_l3 = os.path.join(new_agb_path, 'classic_ukesm1-0-ll_w5e5_ssp126_2015soc-from-histsoc_default_c34_concise_agb_l3_v3.csv')
...
bgb_file_path_l3 = os.path.join(new_bgb_path, 'classic_ukesm1-0-ll_w5e5_ssp126_2015soc-from-histsoc_default_c34_concise_bgb_l3_v3.csv')
