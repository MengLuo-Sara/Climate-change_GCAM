...
p_C_126 <- plot_C_scalar(check_aboveCD_long_combine%>%
    filter(year==2100),"quantile_cat_1", "Scalar","a",19.9,y_title= "SSP126",if_ytitle=TRUE,ifxlabel=FALSE)+
  theme(
...
p_bC_126 <- plot_C_scalar(check_belowCD_long_combine%>%
    filter(year==2100),"quantile_cat_1", "Scalar","b",19.9,if_ytitle=FALSE,ifxlabel=FALSE)#+
  # theme(
