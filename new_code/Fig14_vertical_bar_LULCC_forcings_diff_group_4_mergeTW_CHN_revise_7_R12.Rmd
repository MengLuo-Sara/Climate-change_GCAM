...
write.csv(merged_data_SSP126,paste0(
    figure_save_path,
    "Fig14_merged_data_SSP126_",
    scenarios[1],
    fig_case_name,
    ".csv"
  ))

write.csv(merged_data_SSP370,paste0(
    figure_save_path,
    "Fig14_merged_data_SSP370_",
    scenarios[2],
    fig_case_name,
    ".csv"
  ))

write.csv(merged_data_SSP585,paste0(
    figure_save_path,
    "Fig14_merged_data_SSP585_",
    scenarios[3],
    fig_case_name,
    ".csv"
  ))
...
ggsave(
  paste0(
    figure_save_path,
    "Fig14_LULCC_forcing_diff_spatial_alltype_diff_ori_for_vertical_bar",
