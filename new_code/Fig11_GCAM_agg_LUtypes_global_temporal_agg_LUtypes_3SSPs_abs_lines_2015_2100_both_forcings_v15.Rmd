...
# NAS
root <- "Z:/Meng/back_up_all/4_updates/"
...
landleaf_colors <- c(landleaf_colors_full[1:4])

landleaf_order <- c(u_type[5], u_type[4], u_type[4], u_type[8], u_type[2], u_type[1], u_type[3], u_type[7], u_type[6])
